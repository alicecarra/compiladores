...
use crate::{
    errors::ParsingError, free_registers_temporary, type_enum::Type, untyped::UntypedVar, SCOPE_VEC,
};
...
impl SymbolEntry {
    ...
    pub fn get_type(&self) -> Type {
        match self {
            SymbolEntry::Variable(symbol) => symbol.value_type.clone(),
            SymbolEntry::Function(symbol) => symbol.common.value_type.clone(),
    ...
    pub fn get_key(&self) -> String {
        match self {
            ...
            SymbolEntry::Variable(content) => content.value.to_string(),
            SymbolEntry::Function(content) => content.common.value.to_string(),
    ...
    pub fn name(&self) -> String {
        match self {
            SymbolEntry::Variable(variable) => variable.value.clone(),
            SymbolEntry::Function(function) => function.common.value.clone(),
            _ => "".to_string(),
        }
    }
}
...
pub struct SymbolTable {
    ...
    pub offset: u32,
    pub free_registers: Vec<&'static str>,
}
...
impl SymbolTable {
    pub fn new(scope_type: ScopeType) -> Self {
        Self {
            ...
            scope_type,
            offset: 0_u32,
            free_registers: free_registers_temporary(),
        }
    }
    ...
    pub fn get_register(&mut self) -> Result<String, ParsingError> {
...
pub fn get_symbol_value(symbol: &SymbolEntry) -> String {
